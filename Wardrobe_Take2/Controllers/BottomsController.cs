...
namespace Wardrobe_Take2.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nickname,Photo,Type,Color,Season,Occasion")] Bottoms bottoms)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nickname,Photo,Type,Color,Season,Occasion")] Bottoms bottoms)
        {
            if (ModelState.IsValid)
            {
