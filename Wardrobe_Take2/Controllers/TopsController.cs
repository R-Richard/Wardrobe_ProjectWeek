...
namespace Wardrobe_Take2.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
            if (ModelState.IsValid)
            {
